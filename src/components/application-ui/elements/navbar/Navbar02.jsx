...
export const codeSnippet = `<nav class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-7 py-6">
  ...
  <button class="md:flex hidden px-4 py-2.5 text-sm text-zinc-100 hover:bg-neutral-900/90 transition duration-300 ease-in-out bg-neutral-700 border border-neutral-900 font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-neutral-400">Get started</button>
</nav>
`;
  ...
  return (
    <div className='w-full h-auto p-2'>
      <nav className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-7 py-6'>
        ...
        <button className='md:flex hidden px-4 py-2.5 text-sm text-zinc-100 hover:bg-neutral-900/90 transition duration-300 ease-in-out bg-neutral-700 border border-neutral-900 font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-neutral-400'>Get started</button>
      </nav>
    </div>
  )
}
