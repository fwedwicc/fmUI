...
<div>
  ...
  <input id="email" type="text" class="block w-full rounded-md border border-neutral-200 bg-neutral-100/80 px-3 py-2.5 text-sm transition duration-300 ease-in-out focus:border-neutral-500 focus:ring-1 focus:ring-neutral-500" placeholder="name@email.com" required />
</div>
`;
    ...
    <div className='gap-3 flex justify-center items-center flex-wrap p-6'>
      <div className='w-full max-w-xs space-y-4'>
        <div>
          ...
          <input id='email' type="text" className="block rounded-md w-full bg-neutral-100/80 border border-neutral-200 transition duration-300 ease-in-out focus:ring-1 focus:ring-neutral-500 focus:border-neutral-500 text-sm py-2.5 px-3" placeholder="name@email.com" required />
        </div>
      </div>
    </div>
  )
