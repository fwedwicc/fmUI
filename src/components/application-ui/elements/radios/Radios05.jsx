...
<div class="flex flex-wrap gap-3">
  <div class="inline-flex">
    <input id="heart" type="radio" name="interact" class="peer hidden" />
    <label for="heart" class="flex w-full cursor-pointer items-center justify-between rounded-lg border bg-white p-5 text-zinc-700 transition duration-300 ease-in-out hover:bg-neutral-50 peer-checked:border-neutral-400 peer-checked:bg-neutral-100">
  ...
  <div class="inline-flex">
    <input id="like" type="radio" name="interact" class="peer hidden" />
    <label for="like" class="flex w-full cursor-pointer items-center justify-between rounded-lg border bg-white p-5 text-zinc-700 transition duration-300 ease-in-out hover:bg-neutral-50 peer-checked:border-neutral-400 peer-checked:bg-neutral-100">
      <div class="block space-y-2">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-8">
  ...
  <div class="inline-flex">
    <input id="share" type="radio" name="interact" class="peer hidden" />
    <label for="share" class="flex w-full cursor-pointer items-center justify-between rounded-lg border bg-white p-5 text-zinc-700 transition duration-300 ease-in-out hover:bg-neutral-50 peer-checked:border-neutral-400 peer-checked:bg-neutral-100">
      <div class="block space-y-2">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-8">
  ...
  return (
    <div className='gap-3 flex justify-center items-center flex-wrap p-6'>
      <div className='inline-flex'>
        <input id='heart' type="radio" name='interact' className="hidden peer" />
      ...
      <div className='inline-flex'>
        <input id='like' type="radio" name='interact' className="hidden peer" />
      ...
      <div className='inline-flex'>
        <input id='share' type="radio" name='interact' className="hidden peer" />
